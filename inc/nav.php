<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <!-- Brand -->
  <a class="navbar-brand" href="index.php">ONLINE BOOK SHARING SYSTEM</a>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item mt-2">
      <a class="nav-link" href="customerPage.php">Shop Again</a>
    </li>
	  ...
	  <?php
                  ...
                  $result2 = mysqli_query($conn, $sql2);
                      ...
                      while($row2 = mysqli_fetch_assoc($result2)) {
                          ...
                          ?> 
						  <a class="dropdown-item" href="index.php?id=<?php echo $row2["ID"] ?>"><?php echo  $row2["name"] ?></a>
